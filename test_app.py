...
class FlaskAppTest(unittest.TestCase):
    ...
    def test_home_page(self):
        ...
        self.assertIn("Главная", title)  # Проверяем, что на главной странице в заголовке содержится слово "Home"

    def test_catalog_page(self):
        self.driver.get("http://127.0.0.1:5000/catalog")  # URL страницы каталога
        time.sleep(1)
        title = self.driver.title
        self.assertIn("Каталог товаров", title)  # Проверяем, что на странице каталога в заголовке содержится слово "Catalog"
    ...
    def test_about_page(self):
        ...
        time.sleep(1)
        title = self.driver.title
        self.assertIn("О нас", title)  # Проверяем, что на странице "О нас" в заголовке содержится слово "About"
